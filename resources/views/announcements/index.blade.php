        ...
        <div class="grid gap-5 md:grid-cols-2 lg:grid-cols-3" 
            ...
            @foreach($announcements as $a)
                ...
                <div 
                    ...
                    <p class="text-sm text-blue-50 pr-14 mb-12">{{ Str::limit($a->content, 140) }}</p>
                    ...
                    <img 
                        ...
                        class="w-10 h-10 rounded-full object-cover absolute bottom-3 right-3"
                        alt="User Avatar"
                    />
                </div>
                ...
                <div 
                    ...
                    <div class="p-6 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-2xl shadow-2xl max-w-xl w-full relative">
                        <!-- Content -->
                        ...
                        <p class="text-base leading-relaxed text-blue-50 mb-4 pr-16 pb-12">{{ $a->content }}</p>
                        ...
                        <img 
                            src="{{ $a->user->profile_photo 
                                   ? asset('uploads/profile/' . $a->user->profile_photo)
                                : asset('images/profile.png') }}"
                            class="w-12 h-12 rounded-full object-cover absolute bottom-4 right-4"
                            alt="User Avatar"
                        />
                    </div>
                </div>
